...
/** Native control tests describe bodies, but the ViewModel receives only topology. */
internal fun topologyPage(
    messages: List<RemoteMessage>, nextCursor: String?, queued: List<RemoteQueuedMessage>,
    runtime: RemoteRuntime? = null,
) = RemoteTopologyPage(messages.map { message ->
